...
namespace Ecommerce_Web_API.EntityFramework
{
    using System;
    ...
    public partial class Ecommerce_Web_DBEntities1 : DbContext
    {
        public Ecommerce_Web_DBEntities1()
            : base("name=Ecommerce_Web_DBEntities1")
        {
        }
